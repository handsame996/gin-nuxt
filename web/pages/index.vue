...
<template>
  <div class="body-main">
     <div class="main">
            <div :class="['container','a-container',{ 'is-txl': isHidden }]" id="a-container">
                <a-form id="a-form" class="form" method="" action="">
                    <h2 class="form_title title">Create Account</h2>
                 
                    <div class="flex">
                        <img class="form__icon" src="data:image/svg+xml;base64," alt="">
            ...
            <div :class="['container','b-container', {'is-txl': isHidden, 'is-z200': isHidden }]" id="b-container">
                <a-form id="b-form" class="form" method="" action="">
            ...
            <div :class="['switch',{ 'is-txr': isTxr, 'is-gx': isGx }]"  id="switch-cnt" >
                <div :class="['switch__circle',{ 'is-txr': isTxr }]"></div>
                <div :class="['switch__circle','switch__circle--t',{ 'is-txr': isTxr }]"></div>
...
// // 阻止表单默认提交行为
// const getButtons = (e: Event): void => {
//   e.preventDefault();
// };

// // 表单切换逻辑
// const changeForm = (e: Event): void => {
//   e.preventDefault();
